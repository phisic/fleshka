...
class EmailTemplate extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            array('name, from_name, from, subject, content, legend', 'required'),
            array('name, from_name, from, subject', 'length', 'max'=>255),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id, name, from_name, from, subject, content, legend', 'safe', 'on'=>'search'),
        );
    }
