...
<?php 
	...
	$colorprices = Colorprice::model()->findByPk($colorprice_id);

?>

<?php if (count($colorprices->photoss)>0) : ?>

	<?php foreach ($colorprices->photoss as $key => $photo) : ?>
	...
	$(function() {
        ...
        var uploader = new qq.FileUploader({
            ...
            params: {
				...
				color_id: <?php echo $fleshka->colorprices[$my_colorprice]->color_id; ?>
            },
