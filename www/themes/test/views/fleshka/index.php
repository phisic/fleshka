...
<script type="text/javascript">
	...
	function load_fleshka(fleshka_id)
	{
		$('#edit_fleshka').load('<?php echo Yii::app()->createUrl('fleshka/edit'); ?>', {
			id:fleshka_id
		});
	...
	{
		// reload list 
		$('#all_list').load('<?php echo Yii::app()->createUrl('fleshka/reloadFleshka'); ?>', function() {
